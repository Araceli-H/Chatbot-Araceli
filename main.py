#LIBRERIAS: Códigos escritos por otras personas para que los usemos
#API: Libreria que conecta dos programas
#groq: API para usar un chatbot
#streamlit: API para crear una página web
#import random

#numero_random = random.randint(0,100)
#print(numero_random)

#from random import randint, choice  ----->  Manera de importar funciones especificas de una libreria
#from random import *  --->  importo toodas las funciones sin poner el random.funcion
